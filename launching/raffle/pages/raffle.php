...
$data_hadiah = $resbarang->fetch_row();
  ...
  if(isset($_GET['mabel'])){
    ...
    $sqlwinner = ("SELECT * FROM $nama_table  WHERE phone != '-' AND checked != 'Y' AND attendance = 'Y'   ORDER BY RAND() LIMIT 1");
  }
  ...
  <div class="container-fluid" style="width: 100%; margin: 0 auto;">
    <center><img src="../aset/Logo.png" style="width: 25%;"></center>
    <br>
    <div class="col-md-12">
      ...
      <div class="widget-content padded" id="PanelShuffleResult" style="display: none; background-color:white; opacity: 70%; border-radius: 10px; width: 96%; height: 200px;  z-index: 9999999;">
        ...
        <center>
          <div style="text-transform: uppercase ; font-size: 2vw;"><?php echo $show_data[1]." <br> ".$show_data[2]?></div>
  ...
  <script type='text/javascript'>
    ...
    $query2 = "SELECT phone FROM $nama_table WHERE phone != '' AND attendance = 'Y' AND checked != 'Y' LIMIT 200";
