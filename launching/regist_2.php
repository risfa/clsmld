...
<body style="background-image: url('aset/Background_mobile.png'); background-repeat: no-repeat;">
    <div style="position: fixed; color: white; right: 55px; top: 5px; background: red;">
        ...
        <form method="POST" action="do_regist.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-8 row" >
                    ...
                    <div class="col-9" style="padding: 0">
                        <input style="border-radius:0;" type="text" class="form-control" placeholder="Phone Number" name="phone" required="">
                    </div>
            ...
            <!-- gender -->
            	<center style="color: white;">Select gender:</center>
            	<br>
            ...
            <input type="hidden" id="genderIsi" value="" name="gender">

            <!-- smoke -->
            <br>
            <center style="color: white;">Are you smoker?</center>
            <br>
            <div class="row radio-group">
            ...
            <div id="modal">
                <div class="row radio-group">
                    <div class="col-2"></div>
                    <div class="col-2 radio mybutton" onclick="setCiger('ClassMild')" style="padding-top: 1%;padding-bottom: 1%; height: 70px; text-align: center; margin: 2px;">
    ...
    <a href="logout.php" class="col-4 " style="text-align: center;padding: 1%;background: #dadddd "> <i  style="font-size: 2rem; " class="fas fa-sign-out-alt "></i></a>  
  </div>
</div>
