...
<html lang="en">
  ...
  <body  style="background-image: url('aset/BG.jpg'); background-repeat: repeat-y; background-position:center; ">
    <br>
  ...
  <thead>
    <tr>
      ...
      <th style="text-align: center; color: white;" scope="col">Name</th>
      <th style="text-align: center; color: white;" scope="col">Category</th>
      <th style="text-align: center; color: white;" scope="col">Prize</th>
      <th style="text-align: center; color: white;" scope="col">Unique Code</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td  style="text-align: center; color: white;"><?php echo $list['category']; ?></td>
      <td  style="text-align: center; color: white;"><?php echo $list['nama_hadiah']; ?></td>
      <td style="text-align: center; color: white;">
        <a href="unique_code.php?code=<?php echo $list[0] ?>"><button>UNIQUE CODE</button></a>
      </td>
