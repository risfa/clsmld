...
<body style="background-image: url(''); background-repeat: no-repeat; background-position: center;">
        ...
        <form method="POST" action="do_regist.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-8 row" >
                    ...
                    <div class="col-9" style="padding: 0">
                        <input style="border-radius:0;" type="Text" class="form-control"  name="instagram" placeholder="Your ID" required="">
    ...
    <center>
      <br>
        <input type="submit" name="submit" class="btn btn-primary" style="width: 600%; margin-top: 10px;" value="REGISTER">
        <br>
