...
mysql_select_db("dapps_joker_classmild_talkshow") or die("Cant Found Database");
...
$sql = ("SELECT * FROM `tb_hadiah` WHERE `prosentase_menang` != 0 AND status_hadiah = 'AKTIF'  AND jumlah_hadiah != 0 AND id_spbu = '$id_spbu' AND hadiah_spesial = '0' ORDER BY RAND()");
...
if($varible_rand==""){
	$varible_rand = "ANDA KURANG BERUNTUNG";
}


// echo json_encode($kode_hadiah);
